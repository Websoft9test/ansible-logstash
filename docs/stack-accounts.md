...
These accounts are required for Logstash image installation and configuration

## Logstash

* Logstash administrator username: `admin`
* Logstash administrator password: stored in the file of your server */credentials/password.txt*
